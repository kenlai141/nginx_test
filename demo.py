...
images = [[f"/images/image_part_{i+j*5:03}.jpg" for i in range(1, 6)] for j in range(4)]
...
async def homepage(request):
    ...
    for img in images:
        for item in img:
            await request.send_push_promise(item)
...
app.mount(STATIC_URL, StaticFiles(directory=STATIC_ROOT, html=True), name='static')
